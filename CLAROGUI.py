...
entradaNombre = Entry(ConfigInicial, font=(fuente, 14)).grid(row=0, column=1, pady=10, padx=20)
#---------------------------------------------

#------------------Para ingresar Apellido--------
Label(ConfigInicial, text="Ingrese Apellido: ", font=(fuente, 14)).grid(row=1, column=0, pady=10)
entradaApellido = Entry(ConfigInicial, font=(fuente, 14)).grid(row=1, column=1, pady=10, padx=20)
#---------------------------------------------
...
menuFirma = OptionMenu(ConfigInicial, Firmado,*opcionesFirma).grid(row=2, column=1, pady=10, padx=20)
...
botonComenzar = Button(archivos, width=15, text='Comenzar', font=(fuente, 14), command=comenzar)
